import svgPaths from "./svg-pmfs343q75";
...
function Frame33() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-h-px min-w-px not-italic relative text-ellipsis whitespace-nowrap">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] overflow-hidden relative shrink-0 text-[#2f3e6d] text-[19px] w-full">Select Commitee Recommendation s</p>
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] overflow-hidden relative shrink-0 text-[#6e7ca8] text-[14px] w-full">24 Feb, 2023</p>
    </div>
  );
}
...
export default function LandingPage() {
  return (
    <div className="bg-[#f8f9fb] relative size-full" data-name="Landing page">
      <TopSideBar />
      <NavBar />
      <Frame43 />
