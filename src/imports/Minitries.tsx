import svgPaths from "./svg-rbld9h2fz3";
...
function Enter() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[20px] items-center min-h-px min-w-px relative" data-name="Enter">
      <p className="flex-[1_0_0] leading-[16px] min-h-px min-w-px not-italic relative text-[#6e7ca8] text-[14px] whitespace-pre-wrap">Search Ministries</p>
    </div>
  );
}
