import svgPaths from "./svg-yy4ljbh9ou";
...
import imgEllipse6 from "figma:asset/2aa7c632c02ddeb8c284c4b87e152708212dbc31.png";
import imgEllipse7 from "figma:asset/4a8f8e72f5fe25465071d4ab7006bf2930bf6fc5.png";
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Icons / emoji_events">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icons / emoji_events">
          <mask height="16" id="mask0_85_1747" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_85_1747)">
...
function IconsParty() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons / party">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icons / party">
          <mask height="16" id="mask0_85_1767" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_85_1767)">
...
function IconsAlliance() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons / Alliance">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icons / Alliance">
          <mask height="16" id="mask0_85_1869" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_85_1869)">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Icons / person_raised_hand">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icons / person_raised_hand">
          <mask height="16" id="mask0_85_1823" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_85_1823)">
            <path d={svgPaths.pb22d500} fill="var(--fill-0, #2F3E6D)" id="person_raised_hand" />
          </g>
        </g>
      </svg>
    </div>
...
function Nav3() {
  return (
    <div className="bg-[#f1f2f8] content-stretch flex gap-[4px] items-center px-[8px] py-[4px] relative rounded-[8px] shrink-0" data-name=".nav">
      ...
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[14px] not-italic overflow-hidden relative shrink-0 text-[#3c4c7c] text-[12px] text-ellipsis">Questions</p>
    </div>
  );
}
...
function IconsNotice() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons / Notice">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icons / Notice">
          <mask height="16" id="mask0_85_1783" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_85_1783)">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Icons / Amendments">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icons / Amendments">
          <mask height="16" id="mask0_85_1739" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_85_1739)">
...
function IconsChat() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons / Chat">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icons / Chat">
          <mask height="16" id="mask0_85_1887" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_85_1887)">
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[0] min-h-px min-w-px not-italic relative text-ellipsis">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center overflow-hidden relative shrink-0 text-[#2f3e6d] text-[16px] w-full whitespace-nowrap">
        <p className="leading-[20px] overflow-hidden">{`Let's Raise your voice, Ask questions`}</p>
      </div>
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center overflow-hidden relative shrink-0 text-[#6e7ca8] text-[14px] w-full">
        <p className="leading-[16px] whitespace-pre-wrap">Amplify your voice, pose questions – an invitation to engage, inquire, and foster dialogue</p>
      </div>
    </div>
  );
}

function IconsPersonRaisedHand1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons / person_raised_hand">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icons / person_raised_hand">
          <mask height="16" id="mask0_85_1853" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_85_1853)">
            <path d={svgPaths.pb22d500} fill="var(--fill-0, white)" id="person_raised_hand" />
          </g>
        </g>
      </svg>
    </div>
...
function Buttons() {
  return (
    <div className="bg-[#2766da] content-stretch flex gap-[4px] h-[32px] items-center justify-center overflow-clip p-[8px] relative rounded-[6px] shrink-0" data-name="Buttons">
      <IconsPersonRaisedHand1 />
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-white whitespace-nowrap">
        <p className="leading-[14px]">Ask Question</p>
      </div>
    </div>
  );
}
...
function Header() {
  return (
    <div className="content-stretch flex gap-[8px] items-end relative shrink-0 w-[848px]" data-name="Header">
      <Frame2 />
      <Buttons />
    </div>
  );
...
function ChipAtom() {
  return (
    <div className="bg-[#2766da] content-stretch flex items-center px-[16px] py-[8px] relative rounded-[8px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.1)] shrink-0" data-name="Chip atom">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[14px] not-italic relative shrink-0 text-[12px] text-center text-white">Submitted Questions</p>
    </div>
  );
}
...
function ChipAtom1() {
  return (
    <div className="bg-[#f1f2f8] content-stretch flex items-center px-[16px] py-[8px] relative rounded-[8px] shrink-0" data-name="Chip atom">
      ...
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[14px] not-italic relative shrink-0 text-[#2f3e6d] text-[12px] text-center">Approved Questions</p>
    </div>
  );
}
...
function ChipAtom2() {
  return (
    <div className="bg-[#f1f2f8] content-stretch flex items-center px-[16px] py-[8px] relative rounded-[8px] shrink-0" data-name="Chip atom">
      <div aria-hidden="true" className="absolute border border-[#e3e6f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[14px] not-italic relative shrink-0 text-[#2f3e6d] text-[12px] text-center">Rejected Questions</p>
    </div>
  );
}
...
function IconsQuestionBy() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons / Question by">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icons / Question by">
          <mask height="16" id="mask0_85_1799" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_85_1799)">
            <path d={svgPaths.p36fd1930} fill="var(--fill-0, #2F3E6D)" id="record_voice_over" />
          </g>
        </g>
      </svg>
    </div>
...
function Title() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Title">
      <IconsQuestionBy />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic overflow-hidden relative shrink-0 text-[#3c4c7c] text-[12px] text-ellipsis">Question by</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[12px]" data-name="Icons / emoji_flags">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="Icons / emoji_flags">
          <mask height="12" id="mask0_85_1849" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="12" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="12" id="Bounding box" width="12" />
          </mask>
          <g mask="url(#mask0_85_1849)">
...
function QuestionBy() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0" data-name="Question by">
      <Title />
      <Tags />
    </div>
  );
...
function IconsQuestionTo() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons / Question to">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icons / Question to">
          <mask height="16" id="mask0_85_1813" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_85_1813)">
            <path d={svgPaths.p16310f00} fill="var(--fill-0, #2F3E6D)" id="prompt_suggestion" />
          </g>
        </g>
      </svg>
    </div>
...
function Title1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Title">
      <IconsQuestionTo />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic overflow-hidden relative shrink-0 text-[#3c4c7c] text-[12px] text-ellipsis">Question to</p>
    </div>
  );
}
...
function AvatarName2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Avatar + Name">
      ...
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#3c4c7c] text-[14px] text-ellipsis whitespace-nowrap">
        <p className="leading-[16px]">Addie V. Biela</p>
      </div>
    </div>
  );
}
...
function AvatarName3() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Avatar + Name">
      ...
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#3c4c7c] text-[14px] text-ellipsis whitespace-nowrap">
        <p className="leading-[16px]">TRP</p>
      </div>
    </div>
  );
}
...
function QuestionByTo() {
  return (
    <div className="content-center flex flex-wrap gap-[12px_24px] items-center relative shrink-0 w-full" data-name="Question by + to">
      <QuestionBy />
      <QuestionBy1 />
    </div>
  );
...
function IconsReply() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons / reply">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icons / reply">
          <mask height="16" id="mask0_85_1743" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_85_1743)">
...
function Question() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Question">
      <ul className="block font-['Inter:Regular',sans-serif] font-normal leading-[0] list-disc not-italic relative shrink-0 text-[#3c4c7c] text-[14px] w-full whitespace-pre-wrap">
        <li className="mb-0 ms-[21px]">
          <span className="leading-[20px]">What are the steps taken to tap the potential of Medicinal and Aromatic Plants(MAPs) in Assam, which is one of the biggest repositories of MAPs in the world?</span>
        </li>
        <li className="mb-0 ms-[21px]">
          <span className="leading-[20px]">If,so how much has been spent towards the promotion of MAPs?</span>
        </li>
        <li className="ms-[21px]">
          <span className="leading-[20px]">{`What are the steps taken to attract investments in MAPs through 'Make in India' scheme?`}</span>
        </li>
      </ul>
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 800 1">
            <line id="Line 2" stroke="var(--stroke-0, #E3E6F0)" x2="800" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <QuestionByTo />
...
function Question1() {
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-full" data-name="Question 1">
      <div aria-hidden="true" className="absolute border border-[#f1f2f8] border-solid inset-0 pointer-events-none rounded-[12px]" />
...
function ListOfQuestion() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-h-px min-w-px relative" data-name="List of Question">
      <Question1 />
    </div>
  );
}
...
function Content() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-start min-h-px min-w-px relative w-full" data-name="Content">
      <ListOfQuestion />
    </div>
  );
}
...
function Body() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[900px] items-start left-[calc(16.67%+56px)] right-[calc(16.67%+56px)] top-[100px]" data-name="Body">
      <Header />
      <Actions />
      <Content />
    </div>
...
export default function QuestionsByme() {
  return (
    <div className="bg-[#f8f9fb] relative size-full" data-name="Questions ->Byme">
      <NavBar />
      <TopSideBar />
      <Body />
    </div>
