      ...
      <div className={`content-stretch flex gap-[12px] p-[12px] relative w-full ${isCompact ? 'items-center' : 'items-start'}`}>
        ...
        {requestState === 'accepted' && !coalitionLocked && (
          <button
            ...
            className="shrink-0 flex items-center px-[12px] py-[6px] rounded-[var(--radius-button-small)] bg-transparent border border-[var(--status-rejected-text)] text-[var(--status-rejected-text)] text-[length:var(--text-label)] leading-[14px] hover:bg-[var(--status-rejected-bg)] transition-colors cursor-pointer"
          >
            Decline
          </button>
        )}
        ...
        {requestState === 'none' && !coalitionLocked && (
          <button
            ...
            className="shrink-0 flex items-center px-[12px] py-[6px] rounded-[var(--radius-button-small)] bg-[var(--primary)] text-[var(--primary-foreground)] text-[length:var(--text-label)] leading-[14px] hover:opacity-90 transition-opacity cursor-pointer"
          >
            Send Proposal
          </button>
        )}
        ...
        {requestState === 'sent-pending' && !coalitionLocked && (
          <button
            ...
            className="shrink-0 flex items-center px-[12px] py-[6px] rounded-[var(--radius-button-small)] bg-transparent border border-[var(--status-rejected-text)] text-[var(--status-rejected-text)] text-[length:var(--text-label)] leading-[14px] hover:opacity-90 transition-opacity cursor-pointer"
          >
            Withdraw
          </button>
        )}
        ...
        {requestState === 'received-pending' && !coalitionLocked && (
          <div ref={dropdownRef} className="relative shrink-0">
            <button
              ...
              className="flex items-center gap-[6px] px-[12px] py-[6px] rounded-[var(--radius-button-small)] bg-[var(--primary)] text-[var(--primary-foreground)] text-[length:var(--text-label)] leading-[14px] hover:opacity-90 transition-opacity cursor-pointer"
            >
              Received
              <ChevronDown className={`size-[14px] transition-transform ${receivedDropdownOpen ? 'rotate-180' : ''}`} />
            </button>
            {receivedDropdownOpen && (
...
export function CoalitionFormationModal({ isOpen, onClose }: CoalitionFormationModalProps) {
  ...
  // All accepted partner IDs
  const acceptedPartnerIds = requests
                ...
                {hasMajority && !coalitionLocked && showLockConfirm && (
                  <div className="flex items-center gap-[8px] w-full">
                    <button
                      ...
                      className="flex items-center gap-[6px] px-[12px] py-[6px] rounded-[var(--radius-button-small)] bg-[var(--status-rejected-text)] text-white text-[length:var(--text-label)] leading-[14px] hover:opacity-90 transition-opacity cursor-pointer"
                    >
                      <Lock className="size-[12px]" />
                      Yes, Lock Coalition
                    </button>
                    <button
                      ...
                      className="flex items-center px-[12px] py-[6px] rounded-[var(--radius-button-small)] bg-transparent border border-[var(--foreground)] text-[var(--foreground)] text-[length:var(--text-label)] leading-[14px] hover:bg-[var(--input-background)] transition-colors cursor-pointer"
                    >
                      Cancel
                    </button>
                    <p className="leading-[14px] text-[var(--muted-foreground)] text-[length:var(--text-label)]">
